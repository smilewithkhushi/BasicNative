...
const getSegmentedButtonDensityPadding = _ref => {
  let {
    density
  } = _ref;
...
const getDisabledSegmentedButtonStyle = _ref2 => {
...
const getSegmentedButtonBorderRadius = _ref3 => {
  let {
    segment,
    theme
  } = _ref3;
...
const getSegmentedButtonColors = _ref8 => {
  let {
    theme,
    disabled,
    checked,
