 ...
 */
export default function conditional(condition: Animated.AnimatedInterpolation<0 | 1>, main: Animated.AnimatedInterpolation<number>, fallback: Animated.AnimatedInterpolation<number>): Animated.AnimatedAddition<string | number>;
